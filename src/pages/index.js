      ...
      <div className='container px-4 py-5'>
        <div className='row flex-lg-row-reverse align-items-center py-5 g-5'>
          <div className='col-10 col-sm-8 col-lg-6'>
            <img src='https://images.unsplash.com/photo-1591522810850-58128c5fb089?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80' className='d-block mx-lg-auto img-fluid' width='700' height='500' />
          </div>
          <div className='col-lg-6'>
            ...
            <div className='d-grid gap-2 d-md-flex justify-content-md-start'>
              <button type='button' className='btn btn-primary btn-lg px-4 me-md-2' onClick={btnLoginClick}>
                <img src='/metamask.svg' width='64' className='me-3'/>Conectar com a MetaMask
              </button>
              {wallet}
              {error}
            </div>
